    ...
    <div className="min-h-screen bg-bg-cream bg-dots-pattern relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        {[
          ...
          { num: 7, top: '15%', right: '12%', size: '2.5rem', dur: 15, dx: -20, dy: 25, rot: 12, opacity: 0.20 },
          { num: 3, top: '55%', left: '3%', size: '2rem', dur: 20, dx: 35, dy: -15, rot: -8, opacity: 0.20 },
          { num: 42, top: '30%', right: '5%', size: '3rem', dur: 25, dx: -15, dy: 20, rot: 10, opacity: 0.20 },
          { num: 9, top: '80%', left: '15%', size: '2.2rem', dur: 17, dx: 20, dy: -25, rot: -12, opacity: 0.20 },
          { num: 70, top: '5%', left: '45%', size: '2.8rem', dur: 23, dx: -10, dy: 30, rot: 8, opacity: 0.20 },
          { num: 1, top: '45%', right: '3%', size: '1.8rem', dur: 19, dx: -30, dy: -10, rot: 15, opacity: 0.20 },
          { num: 25, top: '88%', left: '55%', size: '2.5rem', dur: 21, dx: 15, dy: -20, rot: -6, opacity: 0.20 },
          { num: 0, top: '35%', left: '8%', size: '2rem', dur: 16, dx: 25, dy: 15, rot: 10, opacity: 0.20 },
          { num: 56, top: '60%', right: '20%', size: '2.3rem', dur: 24, dx: -20, dy: -15, rot: -14, opacity: 0.20 },
          { num: 14, top: '20%', left: '30%', size: '1.6rem', dur: 26, dx: 10, dy: 20, rot: 6, opacity: 0.20 },
          { num: 88, top: '12%', left: '65%', size: '2rem', dur: 20, dx: 18, dy: -22, rot: -9, opacity: 0.20 },
          { num: 5, top: '40%', left: '22%', size: '1.7rem', dur: 18, dx: -22, dy: 18, rot: 7, opacity: 0.20 },
          { num: 33, top: '75%', left: '40%', size: '2.4rem', dur: 24, dx: 12, dy: 25, rot: -11, opacity: 0.20 },
          { num: 99, top: '50%', left: '70%', size: '1.9rem', dur: 22, dx: -28, dy: -12, rot: 13, opacity: 0.20 },
          { num: 21, top: '92%', right: '30%', size: '2.1rem', dur: 19, dx: 16, dy: 18, rot: -7, opacity: 0.20 },
          { num: 47, top: '25%', left: '85%', size: '1.8rem', dur: 27, dx: -14, dy: -20, rot: 9, opacity: 0.20 },
          { num: 6, top: '65%', left: '60%', size: '1.5rem', dur: 21, dx: 20, dy: 14, rot: -5, opacity: 0.20 },
          { num: 82, top: '3%', right: '35%', size: '2.6rem', dur: 23, dx: -18, dy: 22, rot: 11, opacity: 0.20 },
        ].map((n, i) => (
          <motion.span
            key={i}
            animate={{
